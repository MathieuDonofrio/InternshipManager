      ...
      <div>
        <Container>
          <Box
            ...
            textAlign="left"
          >
            <Typography component="h1" variant="h4" align="center">Téléversement de signature</Typography>
          </Box>
        </Container>
        ...
        <Dialog open={this.state.open} onClose={this.onDialogClose} aria-labelledby="form-dialog-title">
          <DialogTitle id="form-dialog-title">Ajoutez une signature</DialogTitle>
          <DialogContent>
            <Box marginTop={2}>
              <DropzoneArea
                name="files"
                dropzoneText={"Glissez-déposez ou cliquez pour téléversez la signature"}
                filesLimit={1}
...
export default withRouter(UploadSignature);